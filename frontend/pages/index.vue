      ...
      <div class="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-2 lg:items-center lg:py-20">
        <div>
          <h1 class="text-4xl font-extrabold leading-tight text-ink sm:text-5xl">
            ...
            <br />
            <span class="text-pink">hechos con pasión ♡</span>
          </h1>
          ...
          <div class="mt-8 grid grid-cols-4 gap-4 sm:grid-cols-8">
            ...
            <NuxtLink to="/businesses" class="flex flex-col items-center gap-2 text-center">
              <span class="flex h-16 w-16 items-center justify-center rounded-full bg-ink/5 text-ink transition hover:bg-pink hover:text-white">
        ...
        <div class="relative mx-auto flex h-72 w-72 items-center justify-center sm:h-96 sm:w-96">
          <span class="absolute inset-0 rounded-full bg-pink-light" />
          <span class="absolute inset-6 rounded-full border-2 border-dashed border-pink/40" />
          <span class="relative flex h-40 w-40 items-center justify-center rounded-full bg-white text-pink shadow-card sm:h-52 sm:w-52">
            <AppIcon name="heart-filled" :size="72" />
          </span>
        </div>
      </div>
    </section>
    ...
    <section class="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      <div class="mb-6 flex items-center justify-between">
        <h2 class="flex items-center gap-2 text-xl font-bold text-ink">
          <AppIcon name="heart" :size="18" class="text-pink" />
          Emprendimientos destacados
        </h2>
        <NuxtLink to="/businesses" class="text-sm font-semibold text-pink hover:underline">Ver todos</NuxtLink>
      </div>
